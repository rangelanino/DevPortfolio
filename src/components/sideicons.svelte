<div id="iconlinks" class="items-end mr-3 space-x-2 bg-indigo-300 rounded-2xl p-2 shadows-2xl">
    ...
    <a href="https://www.linkedin.com/in/jerico-rangel/" target="_blank" rel="noopener noreferrer">
    ...
    <a href="https://stackoverflow.com/users/20385032/jerico-rangel" target="_blank" rel="noopener noreferrer">
